...
# ─── 个人加仓清单（二级所有活跃持仓 — 💎 标记 + 专属提醒）───
_PERSONAL_WATCH = {
    # 核心仓（二级 ≥10%，重仓股 — 等深度回调再小仓建）
    "DRAM": "🔥 一定会找机会加，等回调-10%或RSI<60",
    "LITE": "二级核心13.86%，等左侧回踩EMA60/-10%分批建",
    "SNDK": "二级浮盈+1003%已重仓，等深度回调再考虑",
    "COHR": "二级核心13.18%，等左侧回踩EMA60/-10%分批建",
    # 中仓（二级 3-5% — 回踩EMA20可分批建中仓）
    "QCOM": "二级中仓5%参考，回踩EMA20建仓",
    "ORCX": "2倍ORCL ETF，波动大，先观察ORCL本体",
    "GFS":  "硅光代工，回踩EMA20可建中仓3-5%",
    "AAOI": "🔥 下周建仓中仓3-5%，左侧分批接",
    "MRVL": "DSP核心，从0建到中仓4-5%",
    # 观察（二级 <3% — 小仓试水或观望）
    "NBIS": "AI Infra，二级仅2.46%，先观察",
    "FORM": "CPO探针台，回踩EMA20可建小仓1-2%",
    "NEBX": "2倍NBIS ETF，波动极大，先观察NBIS本体",
    "AEHR": "光芯片测试，历史DD-72%，慎入",
    "AMD":  "⚠️ 二级5/7已止盈ARM/ALAB，警惕CPU链见顶，先观望",
}
