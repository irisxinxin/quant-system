...
/usr/local/bin/python3 bots/enrich/run_sim.py                 # 44 端到端场景
/usr/local/bin/python3 bots/enrich/sim/mutation_check.py      # 10 个人为缺陷
/usr/local/bin/python3 bots/enrich/test_enrich_bot_safety.py  # 82 单元断言
```
...
- `mutation_check` 故意把 bot 参数改坏，验证场景**不是空转** —— 上一版单元测试把
